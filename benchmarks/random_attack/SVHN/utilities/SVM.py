...
class SVM:
    ...
    def __init__(self, X_train, y_train, X_test, y_test, n_iters, val=True, val_type='k_fold', k=5, opt='mini_batch_GD', batch_size = 64, learning_rate=0.005, lambda_param=0.01):
