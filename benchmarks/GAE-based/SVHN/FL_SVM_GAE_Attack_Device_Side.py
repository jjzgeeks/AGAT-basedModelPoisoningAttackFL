...
from utilities.data_processing import load_mnist_return_required_digits, get_clients, get_total_from_clients, load_cifar10_return_required_digits, load_svhn_return_required_digits,create_kmeans_clusters, load_fashion_mnist_return_required_digits
...
class Federated_SVM:
    def __init__(self, x_train, y_train, n_clients, n_iters, val=True, val_type='k_fold', k=5, opt='mini_batch_GD',
                 batch_size= 64, learning_rate=0.01, lambda_param=0.01):
            ...
            for m_clients in num_malicious_clients_index:
                ...
                savemat("./FL_GAE_results_{}_{}_{}_{}_{}.mat".format(x, n_clients, n_global_commu_round, n_iters,
                        ...
                        {"Global_model_loss": Loss, "Global_model_accuracy": global_accuracy,
                         "Local_model_accuracy": local_clients_accuracy, "KL_distance": KL_div, "cosine_distance": cosine_distance})
