...
def fl_to_gae(parameters,  FL_adj):
    ...
    """cifar10 dataset"""
    w_attack = np.sum(new_features, axis=0) / new_features.shape[0] * np.random.normal(0.0, 1.0, new_features.shape[1]) #* 1e-1 # new_features.shape[0] is column
